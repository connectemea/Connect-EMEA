            ...
            <main className='mx-auto flex items-center flex-col custom-container z-20 text-white text-center'>
                ...
                <section className='flex flex-col md:flex-row items-center justify-center mx-auto my-16'>
                    <div className='basis-1/2 flex items-center justify-center'>
                        <img src="/image/about-1.png" alt="logo" className="" />
                    </div>
                ...
                <section className='flex flex-col md:flex-row w-full items-center justify-center mx-auto my-16'>
                    <div className='basis-1/2'>
                        <div>
                            <Divider>
                                <h1 className='text-5xl font-bold text-secondary'>
                ...
                <section className='flex flex-col  w-full items-center justify-around my-16 bg-white/10 border border-gray-600/50 rounded-2xl min-h-[800px] relative p-16'>
                    <div>
                        <h1 className='text-5xl bg-gradient-to-b text-transparent bg-clip-text from-violet to-[#ffffff]/70 my-10 font-extrabold'>
                            Communities for joy
                        </h1>
                    </div>
                    <div className='flex gap-16 flex-col md:flex-row'>
                        <div className='bg-white/20  flex flex-col items-center justify-around rounded-[40px] max-w-[360px] p-10 gap-4'>
                            <img src='/image/Tinkerhub.png' alt="logo" className="w-auto h-24" />
                        ...
                        <div className='bg-white/20  flex flex-col items-center justify-around rounded-[40px] max-w-[360px] p-10 gap-4'>
                            <img src='/image/SheHikeLogo.png' alt="logo" className="w-auto h-24" />
                            <h1 className='text-3xl font-bold'>
                                SheHike
                            </h1>
                            <p className='text-left'>
