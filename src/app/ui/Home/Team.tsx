...
const Team: React.FC = () => {
    return (
        <div className="min-h-[450px] bg-white/5 backdrop-blur my-2 text-center p-10 flex gap-10 w-full rounded-xl shadow border border-gray-50 flex-col md:flex-row">
            <div className='flex items-center justify-center basis-1/2 border rounded-lg bg-black/5 backdrop-blur border-gray-50'>
            ...
            <div className='flex flex-col items-start justify-between gap-4 basis-1/2'>
                <h1 className="text-6xl bg-gradient-to-b text-transparent bg-clip-text from-violet to-[#ffffff]/70  font-extrabold">Our Team</h1>
                ...
                <Link href="/team" className="text-white">
                    <button className="bg-black/5 shadow backdrop-blur text-white rounded-full px-6 py-2 mt-4 relative z-30 cursor-pointer min-w-[80px] border border-gray-700/50">
                        Show More
                    </button>
                </Link>
            </div>
