...
const Team: React.FC = () => {
    return (
        <div className="min-h-[450px] bg-white/5  dark:bg-black/10 backdrop-blur my-2 text-center p-10 flex gap-10 w-full rounded-xl shadow border border-gray-700/50 flex-col md:flex-row">
            ...
            <div className='flex flex-col items-start justify-between gap-4 basis-1/2'>
                ...
                <p className='text-white  dark:text-black items-start flex justify-start text-left' style={{ overflowWrap: 'anywhere'}}>
                ...
                <Link href="/team" className="text-white   dark:text-black">
                    <button className="bg-black/5 shadow backdrop-blur text-white  dark:text-black rounded-full px-6 py-2 mt-4 relative z-30 cursor-pointer min-w-[80px] border border-gray-700/50 flex items-center justify-center gap-4 hover:gap-10 transition-all ease-in-out">
                        Show More <IoIosArrowForward className='text-white  dark:text-black'/>
                    </button>
                </Link>
            </div>
        </div>
