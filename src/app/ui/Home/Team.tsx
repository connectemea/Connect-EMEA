...
const Team: React.FC = () => {
    return (
        <div className="min-h-[450px] bg-white/5 backdrop-blur my-2 text-center p-10 flex gap-10 w-full rounded-xl shadow border border-gray-700/50 flex-col md:flex-row">
            <div className='flex items-center justify-center basis-1/2 border rounded-lg bg-black/5 backdrop-blur border-gray-700/50'>
                ...
                <img src='/Images/Developer.png' alt='Developer' className='w-1/2' />
